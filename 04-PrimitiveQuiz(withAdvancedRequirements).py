...
response=str(input("What is the capital of France?")) #similar to the basic requirement, i asked for the user input but this time i included emphasized user input must be a string
response = response.str.lower() #this method turns all of the letters in the user input to lowercase letters
